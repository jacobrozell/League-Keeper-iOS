...
**Overall release status:** `Not compliant` — automated audits pass on tab screens; **manual VoiceOver / AXXXL** still required (`accessibility/Manual_todo.md`).
...
| [attendance](screens/attendance.md) | 12 | 3 | 7 | 0 | 2 | Partial |
...
*Zero Required **Fail** in code scope. All screens **Partial** until manual VO/contrast/AXXXL evidence.*
