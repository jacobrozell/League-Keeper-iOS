...
struct AchievementStatsCard: View {
                    ...
                    if let toggle = onToggleAlwaysOn {
                        Button {
                            ...
                            Label(isAlwaysOn ? "Disable Always On" : "Enable Always On", 
                                  systemImage: isAlwaysOn ? "checkmark.circle.fill" : "circle")
                        }
                    }
    ...
    private func barColor(for index: Int) -> Color {
        let colors: [Color] = [
            AppConstants.AccessibleColors.placementAccent,
            AppConstants.AccessibleColors.achievementAccent,
            AppConstants.AccessibleColors.statOrange,
