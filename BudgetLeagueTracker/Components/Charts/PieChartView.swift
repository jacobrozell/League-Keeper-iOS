    ...
    private var legendView: some View {
        VStack(alignment: .leading, spacing: 6) {
            ForEach(data) { item in
                HStack(spacing: 8) {
                    Circle()
                        .fill(item.color ?? Color(uiColor: .systemGray))
...
extension PieChartView {
    /// Default placement colors for consistency (semantic for dark mode).
    static let placementColors: [Int: Color] = [
        1: Color(uiColor: .systemYellow),
        2: Color(uiColor: .systemGray),
        3: Color(uiColor: .systemOrange),
        4: Color(uiColor: .systemBrown)
    ]
    ...
    static func pointsBreakdown(
        ...
        let chartData = [
            PieChartData(id: "placement", label: "Placement", value: placementPoints, color: Color(uiColor: .systemBlue)),
            PieChartData(id: "achievement", label: "Achievement", value: achievementPoints, color: Color(uiColor: .systemGreen))
        ]
...
#Preview("Pie Chart") {
    PieChartView(
        ...
        data: [
            PieChartData(label: "Placement", value: 45, color: Color(uiColor: .systemBlue)),
            PieChartData(label: "Achievement", value: 20, color: Color(uiColor: .systemGreen))
        ],
        style: .pie
    )
    .padding()
