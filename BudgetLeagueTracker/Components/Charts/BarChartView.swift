...
extension BarChartView {
    ...
    static func achievementLeaderboard(
        ...
        return BarChartView(
            title: title,
            data: chartData,
            barColor: Color(uiColor: .systemOrange),
            height: height
        )
    }
    ...
    static func winsComparison(
        ...
        return BarChartView(
            title: title,
            data: chartData,
            barColor: Color(uiColor: .systemPurple),
            height: height
        )
    }
    ...
    static func playerBreakdown(
        ...
        return BarChartView(
            title: title,
            data: chartData,
            barColor: Color(uiColor: .systemTeal),
            height: height
        )
    }
}
...
#Preview("Single Bar Chart") {
    BarChartView(
        ...
        barColor: Color(uiColor: .systemBlue)
    )
    .padding()
}
...
#Preview("Grouped Bar Chart") {
    BarChartView(
        ...
        barColor: Color(uiColor: .systemBlue),
        secondaryColor: Color(uiColor: .systemGreen)
    )
    .padding()
}
