...
// MARK: - Snapshot trait helpers (dark mode, etc.)

/// Use for snapshot tests that need dark color scheme. Wrap the view and use a distinct `named` (e.g. "Name_dark") so dark refs are stored separately.
extension View {
    func darkModeForSnapshot() -> some View {
