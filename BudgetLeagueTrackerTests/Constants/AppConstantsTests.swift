...
struct AppConstantsTests {
    ...
    @Suite("AccessibleColors")
    struct AccessibleColorsTests {

        @Test("Semantic colors exist for dark mode support")
        func semanticColorsExist() {
            _ = AppConstants.AccessibleColors.activeStatusBackground
            _ = AppConstants.AccessibleColors.winnerAccent
            _ = AppConstants.AccessibleColors.statOrange
            _ = AppConstants.AccessibleColors.statYellow
            _ = AppConstants.AccessibleColors.semanticGray
            _ = AppConstants.AccessibleColors.placementAccent
            _ = AppConstants.AccessibleColors.achievementAccent
        }
    }
