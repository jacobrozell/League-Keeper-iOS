...
struct ComponentSnapshotTests {
    ...
    struct PrimaryActionButtonSnapshots {
        ...
        func enabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "PrimaryActionButton_enabledState", record: SnapshotTestConfiguration.record)
        }
        ...
        func disabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "PrimaryActionButton_disabledState", record: SnapshotTestConfiguration.record)
        }
    }
    ...
    struct SecondaryButtonSnapshots {
        ...
        func enabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "SecondaryButton_enabledState", record: SnapshotTestConfiguration.record)
        }
        ...
        func disabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "SecondaryButton_disabledState", record: SnapshotTestConfiguration.record)
        }
    }
    ...
    struct DestructiveActionButtonSnapshots {
        ...
        func enabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "DestructiveActionButton_enabledState", record: SnapshotTestConfiguration.record)
        }
        ...
        func disabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "DestructiveActionButton_disabledState", record: SnapshotTestConfiguration.record)
        }
    }
    ...
    struct PlacementPickerSnapshots {
        ...
        func selection1() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), record: SnapshotTestConfiguration.record)
        }
        ...
        func disabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 300, height: 80)), named: "PlacementPicker_disabledState", record: SnapshotTestConfiguration.record)
        }
    }
    ...
    struct AchievementCheckItemSnapshots {
        ...
        func disabledState() {
            ...
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 350, height: 200)), named: "AchievementCheckItem_disabledState", record: SnapshotTestConfiguration.record)
        }
    }
    ...
    struct TournamentCellSnapshots {
        ...
        @Test("Ongoing tournament (dark mode)")
        func ongoingTournamentDark() {
            let tournament = TestFixtures.tournament(name: "Spring League 2026")
            let cell = TournamentCell(
                tournament: tournament,
                playerCount: 6,
            ...
            let view = cell.frame(width: 350).darkModeForSnapshot()
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 350, height: 200)), named: "ongoingTournament_dark", record: SnapshotTestConfiguration.record)
        }
    ...
    // MARK: - HintText Snapshots
    
    @Suite("HintText")
    @MainActor
    struct HintTextSnapshots {
        @Test("With message")
        func withMessage() {
            let view = HintText(message: "Select at least one player to continue.")
                .frame(width: 350)
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 350, height: 200)), record: SnapshotTestConfiguration.record)
        }
        ...
        @Test("Long message")
        func longMessage() {
            let view = HintText(message: "This is a longer hint that might wrap to multiple lines in the UI.")
                .frame(width: 350)
            assertSnapshot(of: view, as: .image(precision: 0.98, layout: .fixed(width: 350, height: 200)), record: SnapshotTestConfiguration.record)
        }
    }
